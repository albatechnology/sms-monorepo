            ...
            <form method="POST" action="{{ route('admin.products.update', [$product->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('company') ? 'is-invalid' : '' }}" name="company_id"
                        ...
                        @foreach ($companies as $id => $company)
                            <option value="{{ $id }}"
                                {{ (old('company_id') ? old('company_id') : $product->company->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $company }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('product_brand_id') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($productBrands as $id => $productBrand)
                            <option value="{{ $id }}" {{ $id == $product->product_brand_id ? 'selected' : '' }}>
                                {{ $productBrand }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('product_category_id') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($categories as $id => $category)
                            <option value="{{ $id }}"
                                {{ $id == $product->product_category_id ? 'selected' : '' }}>
                                {{ $category }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number"
                        name="price" id="price" value="{{ $product->price }}" min="0">
                    @if ($errors->has('price'))
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1"
                            {{ $product->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
